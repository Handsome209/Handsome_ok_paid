...
def banner():
	clear()
	sol()
	ban=''' Â© LEGEND MR HANDSOME OFFICIAL
                      _
  /\  /\__ _ _ __   __| |___  ___  _ __ ___   ___ 
 / /_/ / _` | '_ \ / _` / __|/ _ \| '_ ` _ \ / _ \ [â€¢] Insta: Mr Handsome Official 
/ __  / (_| | | | | (_| \__ \ (_) | | | | | |  __/[â€¢] Facebook: Mr Handsome
\/ /_/ \__,_|_| |_|\__,_|___/\___/|_| |_| |_|\___| [â€¢] Master MindðŸ¥ºâ¤ï¸                                      '''
